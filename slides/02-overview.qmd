...
```{r}
#| label: mu_data
roster <- read.csv("./data/marquette_roster_2025_26.csv")
...
major <- c("Engineering" = 17,
           "Bio related" = 10, "Other STEM" = 6)
pie(major, col = 2:4, main = "Major of 4720/5720 class", cex = 1.4)
```
